...
{
    public class InvoiceProductRepository:EntityRepository<InvoiceProduct>,IInvoiceProductRepository
    {
        private CarContext carContext { get => _context as CarContext; }
        public InvoiceProductRepository(DbContext context):base(context)
        {
